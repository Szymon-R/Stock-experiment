...
public class Last_screen extends javax.swing.JFrame {
    ...
    public Last_screen(ClientSide ClientSide1) {
        ...
        final SwingWorker<String, Void> worker1 =  new SwingWorker<String, Void>() 
        {
            ...
            protected void done() 
            {
                ...
                double temp=Double.parseDouble(output);
                temp=Math.round(temp);
                jTextField1.setText(jTextField1.getText()+Double.toString(temp));
            }
        };
        worker1.execute();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Last_screen.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ...
                new Last_screen(cs).setVisible(true);
            }
        });
    }
